...
//                             child: Text(ordersData.orders[index].orderId.toString(),
//                                 textAlign: TextAlign.center,
//                                 style: Theme.of(context).textTheme.xxTiniest)),
//                         onTap: () {
//                       Navigator.pushReplacementNamed(
//                           context, OrderDetailsScreen.routeName,
//                           arguments: ordersData.orders[index]);
//                     }),
//                     DataCell(
//                         Text(
//                             DateFormat('dd MMM yyyy')
//                                 .format(ordersData.orders[index].orderDate),
//                             style: Theme.of(context).textTheme.xxTiniest),
//                         onTap: () {
//                       Navigator.pushReplacementNamed(
//                           context, OrderDetailsScreen.routeName,
...
//                     }),
//                     DataCell(
//                         Text(ordersData.orders[index].customerContact.toString(),
//                             style: Theme.of(context).textTheme.xxTiniest),
//                         onTap: () {
//                       Navigator.pushReplacementNamed(
//                           context, OrderDetailsScreen.routeName,
...
//                     }),
//                     DataCell(
//                         Text(ordersData.orders[index].customerName.toString(),
//                             textAlign: TextAlign.center,
//                             style: Theme.of(context).textTheme.xxTiniest),
//                         onTap: () {
//                       Navigator.pushReplacementNamed(
...
//                     }),
//                     DataCell(
//                         Text(ordersData.orders[index].paymentType.toString(),
//                             textAlign: TextAlign.center,
//                             style: Theme.of(context).textTheme.xxTiniest),
//                         onTap: () {
//                       Navigator.pushReplacementNamed(
