...
import 'package:saasify/services/pdf_api.dart';

import '../data/models/pdf/invoice.dart';
import '../data/models/pdf/invoice_customer.dart';
import '../data/models/pdf/supplier.dart';
...
class PdfInvoiceApi {
  ...
  static Widget buildHeader(Invoice invoice) => Column(
        ...
        children: [
          ...
          Row(
            ...
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              buildCustomerAddress(invoice.invoiceCustomer),
  ...
  static Widget buildInvoice(Invoice invoice) {
    ...
    final data = invoice.items.map((item) {
      ...
      return [
        item.description,
        InvoiceUtils.formatDate(item.date),
        '${item.quantity}',
        '\$ ${item.unitPrice}',
        '${item.vat} %',
